...
# 查看详细错误
cd /D/AI/Claude/CVE
/D/AI/cursor/starone/.venv/Scripts/python.exe cve_integrated_gui.py 2>&1 | tee gui_output.log
```
...
```bash
# 启动Redis Commander
docker-compose -f docker-compose-gpu.yml up -d redis-commander
...
**SQLite数据库位置**:
```
D:\AI\Claude\CVE\cve_data\cve_database.db
```
